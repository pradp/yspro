...
function showPreview(str){
	top.Dialog.open({InnerHtml:"<div style=\"text-align:center;\"><img  width='900' height='544' src='../pages/main_preview/"+str+"'/></div>",Title:"皮肤预览",Width:920,Height:550});
}
function changeSkin(str1,str2){
	showProgressBar();
	document.getElementById("sessionSkin").src="sessionSkin1.php?skinName="+str1+"&themeColor="+str2;
}
</script>
<style>
	.framegrid_con{
...
<body>
	<div class="red font_bold">试用版只提供两套皮肤。如需要更多皮肤请购买个人版或企业版。</div>
	<div class="clear"></div>
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="../../pages/main_preview/sky_accordtion_small.jpg"/></div>	
	...
	<div class="framegrid nocaption" style="display:none;">
		<div class="picItem3"><img src="../../pages/main_preview/grass_accordtion_small.jpg"/></div>	
		<div class="framegrid_cover">
