  ...
  <head>
	...
	function doUpload(){
		...
		if(f){
			...
			alert("只允许上传Excel文件，如后缀名是 xls、xlsx、csv 的文件！");
		}
	}
									...
									<td class="chaxunleft">
										<table id="searchForm" border="0" align="center" cellspacing="1" cellpadding="0" width="100%">
											<tr align="left">
												...
												<td align="left" nowrap="nowrap" widht="20%">
													<s:file name="excelFile" id="excelFile"/>&nbsp;&nbsp;
												</td>
												<td align="left" nowrap="nowrap" widht="10%">
													<ul class="btn_gn">						
														<li>
							...
							<table id="buttonTable" border="0" cellspacing="3"
								...
								<tr>
									<td height="30px" width="440px">
										<ul class="btn_gn">										
											<li>
												<a href="#" title="进入登记页面" onClick="enterReg();" disabled="true"  
													id="enterRegButton"><span>进入登记页面</span> </a>
											</li>										
											<li>
