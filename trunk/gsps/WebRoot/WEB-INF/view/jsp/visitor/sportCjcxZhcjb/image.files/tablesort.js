...
function sortColumn(e) {
	...
	if (el != null) {
		var p = el.parentNode;
		if (el == p.cells[0]) {// add by yangjianliang 20081114,escape first
								// cell for checkbox area
			return;
		}
		var i;
...
function getParent(el, pTagName) {
	if (el == null)
		return null;
			...
			&& el.tagName.toLowerCase() == pTagName.toLowerCase()) // Gecko bug, supposed to be uppercase
		return el;
	else
