...
(function() {
	...
	(function() {
		...
		/*窗体*/
		"<div id='ym-window' style='position:absolute;z-index:10001;display:none;cursor:move'>", IE6 ? "<iframe src='javascript:false' style='width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1'></iframe>": '', "<div class='ym-tl' id='ym-tl'><div class='ym-tr'><div class='ym-tc' style='cursor:move;'><div id='ym-header-text' class='ym-header-text'></div><div class='ym-header-tools'>", "<div class='ymPrompt_min' title='最小化'><strong></strong></div>", "<div class='ymPrompt_max' title='最大化'><strong></strong></div>", "<div class='ymPrompt_close' title='关闭'><strong></strong></div>", "</div></div></div></div>", "<div class='ym-ml' id='ym-ml'><div class='ym-mr'><div class='ym-mc'><div class='ym-body' style='position:relative'></div></div></div></div>", "<div class='ym-ml' id='ym-btnl'><div class='ym-mr'><div class='ym-btn'></div></div></div>", "<div class='ym-bl' id='ym-bl'><div class='ym-br'><div id='ym_bc_div' class='ym-bc'></div></div></div>", "</div>",
		/*阴影*/
		...
		var winVisible = function(visible) {
			...
			if (visible === false) { //关闭
				...
				var closeFn = function() {
					...
					try{
						closeInputWindow();//add by yjl at 2009-11-26 for 自动判断是否需要刷新当前页面。此方法在webctrl.js里
					} catch(e) {}
				};
				/*渐变方式关闭*/
