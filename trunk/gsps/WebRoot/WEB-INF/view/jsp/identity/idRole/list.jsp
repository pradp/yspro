    ...
    <s:hidden name="pager.formname" value="theform"/>
    	<table width="100%"border="0" cellspacing="3" cellpadding="0">
    		<tr>
    			...
    			<ul class="btn_gn">
			    <li><a href="#" title="新增角色" onclick="input()"><span>新增角色</span></a></li>
			    <li><a href="#" title="修改角色" onclick="modifySelected()"><span>修改角色</span></a></li>
			    <li><a href="#" title="删除角色" onclick="submitRemove()"><span>删除角色</span></a></li>
			</ul>
    			</td>
    		</tr>
    	</table>
	      ...
	      <tr>
	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="middle">
		    	...
		    	<s:iterator value="resultData">
		    		<tr>
		    			<td ><s:checkbox id="%{roleid}" name="selectNode" fieldValue="%{roleid}"/></td>
		    			<td>
		    				<a href="javascript:input('<s:property value="roleid"/>',false)"><font color="blue"><s:property value="roleName"/></font></a>
		    			</td>
		    			...
		    			<td>
		    			[<a href="javascript:input('<s:property value="roleid"/>',false)" ><FONT color="blue">编辑</FONT></a>]
		    			</td>
		    		</tr>
		    	</s:iterator>
		    	</tbody>
