...
<%
	...
	//out.println(departid);
	//if(departid!=null && departid.length()==6 && request.getParameter("reEnter")==null){
		//代表团登录自动转到代表团全部成绩榜
		//response.sendRedirect("/SportsScore/visitor/sportCjcxNbbd-list.c?cssS=7");
		//request.getRequestDispatcher("/SportsScore/visitor/sportCjcxNbbd-list.c?cssS=7").forward(request, response);
		//out.print("代表团登录自动转到代表团全部成绩榜");
		//return;
	//}
%>
<html>
...
function MM_swapImage_judge() {
	...
	if (objsrc == "t0.gif"){newsrc = baseUrl + "resources/images/middleFrameRight0.gif";}
	else if (objsrc == "ft.gif"){newsrc = baseUrl+"resources/images/middleFrameRight.gif";}
	MM_swapImage('switchPoint','',newsrc,1);
}
function MM_swapImgRestore_judge() {
	if (left_iframe.style.display==""){
		var url = baseUrl + "resources/images/middleFrameLeft.gif";
		switchPoint.src = url;
	}
	else{
		var url = baseUrl + "resources/images/middleFrameLeft0.gif";
		switchPoint.src = url;
	}
}
...
function showHideMenu(){
	if (left_iframe.style.display==""){left_iframe.style.display="none";switchPoint.src=baseUrl+"resources/images/middleFrameLeft0.gif";}
	else{left_iframe.style.display="";switchPoint.src= baseUrl+"resources/images/middleFrameLeft.gif";}
}
...
function prevLoadImages(){
	MM_preloadImages(baseUrl+'resources/images/middleFrameLeft0.gif',baseUrl+'resources/images/middleFrameRight0.gif',baseUrl+'resources/images/middleFrameLeft.gif',baseUrl+'resources/images/middleFrameRight.gif');
	//resetSystemHeight();
}
function execLogout(){
	var url = baseUrl + 'identity/logout.c';
...
function dologout() {
	var logouturl = baseUrl+"identity/logout.c";
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
			<tr>
				<td colspan="3" id="header">
					<iframe src="../headBanner.jsp"
						style="height:130;visibility:inherit;width:100%;background-color:#FFFFFF"
