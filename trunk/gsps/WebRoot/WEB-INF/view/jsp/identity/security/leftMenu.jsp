...
<%@ page import="com.imchooser.framework.identity.entity.TSysMenu"%>
<%
	...
	List tsysMenues = (List) session.getAttribute(com.imchooser.framework.identity.IdConstants.SESSION_USER_RIGHT_MENUS);
	String sysMessage = "";
	if (tsysMenues == null) {
