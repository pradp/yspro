...
/**
 * TSportCjSxHzYl entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class TSportCjSxHzYl implements java.io.Serializable {
	...
	/** default constructor */
	public TSportCjSxHzYl() {
	}

	/** minimal constructor */
	public TSportCjSxHzYl(String wid, Short djjydh) {
		this.wid = wid;
		this.djjydh = djjydh;
	}

	/** full constructor */
	public TSportCjSxHzYl(String wid, Short djjydh, String dbtmc, String yddmc, String departid, Double df, Double jps,
	...
	//TSportCjSxHzYlServiceImpl中的list使用
    public TSportCjSxHzYl(String wid, String dbtmc, String yddmc,Double df,Double jps,Double yps,Double tps,Double hjjps,
  ...
  //TSportCjSxHzYlServiceImpl中的load使用
    public TSportCjSxHzYl(String wid, Double jjf,Double jjjps,Double jjyps,Double jjtps) {
    	this.wid = wid;
    	this.jjf = jjf;
        this.jjjps = jjjps;
        this.jjyps = jjyps;
