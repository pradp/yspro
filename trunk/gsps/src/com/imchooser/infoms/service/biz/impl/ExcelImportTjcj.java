 ...
 * datetime 2010-5-13
 */
public class ExcelImportTjcj implements ExcelImportCustomService {

	private static final Log LOG = LogFactory.getLog(ExcelImportTjcj.class);

	/* (non-Javadoc)
	 * @see com.imchooser.infoms.service.sys.ExcelImportCustomService#customMethodAfterImport()
	 */
	public void customMethodAfterImport() {
		String prod = SQLConfigUtil.getProcName("procd.sports_jk_tj");
		String result = null;
		try {
	...
	public void customMethodBeforeImport() {
		// 清除临时表数据
		DBUtil.executeSQL("delete from t_sport_jk_tj");
	}
