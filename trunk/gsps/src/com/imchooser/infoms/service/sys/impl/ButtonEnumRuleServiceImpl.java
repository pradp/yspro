...
import com.imchooser.infoms.action.sys.ButtonEnumRuleAction;
...
public class ButtonEnumRuleServiceImpl extends BaseServiceAbstractSupport {
	...
	public void load(Object myaction) throws Exception {
		...
		if (Constants.BUTTON_RULE_EACH_DAY == Integer.parseInt(tsysButtonRule
				.getCycleType())) {//
		...
		} else if (Constants.BUTTON_RULE_EACH_MONTH == Integer.parseInt(tsysButtonRule.getCycleType())) {// 每月
			action.setParameter("ksHao", tsysButtonRule.getCycleStart());
			action.setParameter("jsHao", tsysButtonRule.getCycleEnd());
		} else if (Constants.BUTTON_RULE_EACH_YEAR == Integer.parseInt(tsysButtonRule.getCycleType())) {// 每年
	...
	public boolean remove(Object myaction) throws Exception {
		...
		if (deleteSuccess1 && deleteSuccess2) {
			BusinessLogUtil.log(action.getLoginUser().getUserLoginId(),
					Constants.CZDX_T_SYS_BUTTON_RULE, Constants.LOG_ACTION_DEL);
		}
	...
	public void saveOrUpdate(Object myaction) throws Exception {
		...
		if (Constants.BUTTON_RULE_EACH_DAY == Integer
		...
		} else if (Constants.BUTTON_RULE_EACH_MONTH == Integer
		...
		} else if (Constants.BUTTON_RULE_EACH_YEAR == Integer
