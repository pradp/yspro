...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-color: #FFFFFF">
						...
						<table width="100%" height="120px" border="0" cellspacing="0"
							...
							<tr>
								<td align="center" colspan="2">
									<button class="button" type="button" onclick="window.location='./identity/index.action'"><span>进入系统</span></button>
									&nbsp;&nbsp;									
									<button class="button" type="button" onclick="execLogout();"><span>退&nbsp;&nbsp;&nbsp;出</span></button>
								</td>
							</tr>
						</table>
						<table width="100%" height="120px" border="0" cellspacing="0" cellpadding="0" id="drq_table">
