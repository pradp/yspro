...
{
	var unit_id     = "867554";
	var client_ip   = "61.55.188.165";
	var server_time = "1323224670";
	var verify_code = "a8d7743f";
	var type        = "2";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.alimama.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/867554/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
