...
public class AutoSuggest extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (openSuggestCacheModel) {
			...
			if (suggestCache.containsKey(cacheKey)) {
				...
				responseString = queryFromDB(aim, qvalue, departid);
	...
	protected static String queryFromDB(String aim, String qvalue, String... parms) {

		String responseString = "";
		String sql = SQLConfigUtil.getSql("suggest." + aim);
		Object[] obj = new Object[10];
		if (sql == null || sql.trim().equals("")) {
			return "";
		}

		if (aim.indexOf("depart") != -1) {
			obj[0] = "%" + qvalue.toUpperCase() + "%";
			obj[1] = "%" + qvalue.toUpperCase() + "%";
			if (null != parms[0])
				obj[2] = parms[0] + "%";
		}
