...
import com.yszoe.sys.action.SysBizLogAction;
...
public class SysBizLogServiceImpl extends AbstractBaseServiceSupport {
	...
	public List<?> list(Object myaction, Pager pager) throws Exception {
		...
		String hqlcolumn = "select a.wid,(select zdmc from TSysCode where zdlb='czdx' and zdbm=a.czdx) as czdx," +
				"a.czr,a.czlx,to_char(a.czsj,'yyyy-mm-dd hh24:mi:ss'),a.czdx,a.clientIp";
