...
import com.yszoe.biz.action.ExpertqaExpertsMineAction;
 ...
 * datetime 2011-7-22
 */
public class ExpertqaExpertsMineImpl extends AbstractBaseServiceSupport {

	private static final Log LOG = LogFactory.getLog(ExpertqaExpertsMineImpl.class);
	...
	public List<?> list(Object myaction, Pager pager) throws Exception {
		ExpertqaExpertsMineAction action = (ExpertqaExpertsMineAction) myaction;
	...
	public void load(Object myaction) throws Exception {
		...
		if (tsysuser.getUserloginid().equals("admin")){
			wid="20110819093755453102";
		}else{
			wid=tsysuser.getUserid();
		}
