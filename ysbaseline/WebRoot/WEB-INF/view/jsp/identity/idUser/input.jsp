...
<div class="framestyle" style="width:100%;">
  ...
  <table width="100%" border="0" align="center">
    <tr> 
      ...
      <td align="center" nowrap="nowrap">所属部门：<s:textfield id="departname" name="tsysUser.depart.departname" maxlength="25" size="30" /><label style="color:red">*</label></td>
      <td align="center" nowrap="nowrap">身份类型：<s:select id="usertype" name="tsysUser.usertype"  list="#{'':'无特殊身份','1':'业务主管'}" listKey="key" listValue="value"/><label style="color:red">*</label></td>
	<td>&nbsp;</td>
    </tr>
  </table>
