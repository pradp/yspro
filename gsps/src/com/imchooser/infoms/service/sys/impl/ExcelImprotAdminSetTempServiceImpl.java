...
import com.imchooser.infoms.action.sys.ExcelImprotAdminSetTempAction;
 ...
 * @time 2009-01-10
 */
public class ExcelImprotAdminSetTempServiceImpl extends BaseServiceAbstractSupport{
	...
	public List<?> list(Object arg0, Pager pager) throws Exception {
		...
		return DBUtil.queryPageList(pager, "SELECT wid,tempname,mappingtable FROM t_import_temp ORDER BY mappingtable ASC");
	}
