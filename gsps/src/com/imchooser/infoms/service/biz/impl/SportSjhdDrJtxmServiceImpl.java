...
import com.imchooser.infoms.action.biz.SportSjhdDrJtxmAction;
import com.imchooser.infoms.entity.biz.TSportBsxm;
import com.imchooser.util.StringUtil;

/**
 * 多人集体承训地数据核对
 * @author LiuHaiDong 2010-6-2
 */
public class SportSjhdDrJtxmServiceImpl extends BaseServiceAbstractSupport {

	public List<?> list(Object myaction, Pager pager) throws Exception {
		SportSjhdDrJtxmAction action = (SportSjhdDrJtxmAction) myaction;
		...
		String sql1 = " select yy.bssj,yy.scbm,yy.xmmc,yy.departid,yy.ydyxm,yy.jps,yy.yps,yy.tps,yy.df from ( "
				...
				+ " (t.dxmmc||'，'||t.xxmmc) as xmmc,  (select h.departname from t_sys_depart h where h.departid=x.xyjfdq3) as departid, "
				...
				+ " where b.scbm=t.scbm and b.departid=t.departid  and u.dfly=b.ydybm and u.departid=x.xyjfdq3 and u.scbm=b.scbm) as ydyxm,"
		...
		String sql = " from  t_sport_cj_ydy b,t_sport_ydyxx x,t_sport_cj_zs_mx u,t_sport_cj_td_mx r,t_sport_cj_jt t "
				...
				+ " where b.ydybm=x.wid and x.xyjfdq3 is not null "
				+ " and t.scbm=b.scbm and u.scbm=b.scbm and r.scbm=b.scbm and t.departid=b.departid and u.dfly=b.ydybm and r.departid=u.departid and r.dflx='3'"
		...
		if (StringUtils.isNotBlank(action.getParameter("bssj"))) {
			sql += " and to_char((select a.bssj from t_sport_ssrc a where a.wid=t.scbm),'yyyy-MM-dd')= '" + action.getParameter("bssj")+"'" ;
		}
