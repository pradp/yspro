...
/**
 * TSportCjTdHzYl entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class TSportCjTdHzYl implements java.io.Serializable {
	...
	/** default constructor */
	public TSportCjTdHzYl() {
	}

	/** minimal constructor */
	public TSportCjTdHzYl(String wid, Short djjydh) {
		this.wid = wid;
		this.djjydh = djjydh;
	}

	/** full constructor */
	public TSportCjTdHzYl(String wid, Short djjydh, String dbtmc, String yddmc, String departid, Double df, Double jps,
	...
	//TSportCjTdHzYlServiceImpl中的list使用
    public TSportCjTdHzYl(String wid, String dbtmc, String yddmc,Double df,Double jps,Double yps,Double tps,Double hjjps,
    		              Short mc,Double jjf,Double jjjps,Double jjyps,Double jjtps,String hzlx) {
        this.wid = wid;
        this.dbtmc = dbtmc;
        this.yddmc = yddmc;
        this.df = df;
  ...
  //TSportCjTdHzYlServiceImpl中的load使用
    public TSportCjTdHzYl(String wid, Double jjf,Double jjjps,Double jjyps,Double jjtps) {
    	this.wid = wid;
    	this.jjf = jjf;
        this.jjjps = jjjps;
        this.jjyps = jjyps;
