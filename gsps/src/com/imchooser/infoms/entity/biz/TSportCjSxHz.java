...
/**
 * TSportCjSxHz entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class TSportCjSxHz implements java.io.Serializable {
	...
	/** minimal constructor */
	public TSportCjSxHz(String wid, Short djjydh) {
		this.wid = wid;
		this.djjydh = djjydh;
	}

	/** full constructor */
	public TSportCjSxHz(String wid, Short djjydh, String dbtmc, String yddmc, String departid, Double df, Double jps,
    ...
    public TSportCjSxHz(String wid, String dbd, String dbtmc,String yddmc,Double jjf,Double jjjps,Double jjyps,Double jjtps) {
        this.wid = wid;
        this.dbd = dbd;
        this.dbtmc = dbtmc;
        this.yddmc = yddmc;
  ...
  //TSportCjTdHzServiceImpl中的load使用
    public TSportCjSxHz(String wid, Double jjf,Double jjjps,Double jjyps,Double jjtps) {
    	this.wid = wid;
    	this.jjf = jjf;
        this.jjjps = jjjps;
        this.jjyps = jjyps;
