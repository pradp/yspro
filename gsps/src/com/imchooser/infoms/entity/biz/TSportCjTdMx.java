...
/**
 * TSportCjTdMx entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class TSportCjTdMx implements java.io.Serializable {
	...
	private String isjzrq; //是否截止日期
	private String zb; //组别 手动添加
	private String xbz;//性别组 手动添加
	// Constructors
	...
	/** minimal constructor */
	public TSportCjTdMx(String wid, Short djjydh) {
		this.wid = wid;
		this.djjydh = djjydh;
	}

	/** full constructor */
	public TSportCjTdMx(String wid, Short djjydh, String dxmmc, String xxmmc, String scbm, String dbtmc, String yddmc,
			String departid, Double df, Double jps, Double yps, Double tps, String dbd, Short mc,
			Double jjf, Double jjjps, Double jjyps, Double jjtps, String shzt, Date createtime, String bz, String dflx,
	...
	//TSportCjTdMxServiceImpl中的list使用
    public TSportCjTdMx(String wid, String dbtmc,String dxmmc, String xxmmc, String createtime1,Double jjf, Double jjjps,Double jjyps,Double jjtps) {
        this.wid = wid;
        this.dbtmc = dbtmc;
        this.dxmmc = dxmmc;
        this.xxmmc = xxmmc;
    ...
    //TSportCjTdMxServiceImpl中的load使用
      public TSportCjTdMx(String wid,Double jjf, Double jjjps,Double jjyps,Double jjtps) {
      	  this.wid = wid;
      	  this.jjf = jjf;
          this.jjjps = jjjps;
          this.jjyps = jjyps;
	...
	public String getIsjzrq() {
		return isjzrq;
	}

	public void setIsjzrq(String isjzrq) {
		this.isjzrq = isjzrq;
	}
