...
/**
 * TSportCjTdSxJjfMx entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class TSportCjTdSxJjfMx implements java.io.Serializable {
	...
	/** default constructor */
	public TSportCjTdSxJjfMx() {
	}

	/** minimal constructor */
	public TSportCjTdSxJjfMx(String wid, String departid) {
		this.wid = wid;
		this.departid = departid;
	}

	/** full constructor */
	public TSportCjTdSxJjfMx(String wid, String departid, Double jjf, Double jjjps, Double jjyps, Double jjtps,
			String bz) {
		this.wid = wid;
		this.departid = departid;
		this.jjf = jjf;
