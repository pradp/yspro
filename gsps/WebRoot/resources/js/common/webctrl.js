...
$.getScript("/SportsScore/component/ymprompt/ymPrompt_source.js");
...
function openWindow(uri, width, height){	
    ...
    ymPrompt.win({
        width: width,
        height: height,
        title: '<img id="loadingImage" src="/SportsScore/resources/images/loading.gif" border="0">',
        maskAlphaColor: '#fff',
        maskAlpha: '0.5',
        handler: winhandler,
        maxBtn: true,
...
function changeButtonStyle(obj,flag) {
	if(flag==true){
		obj.style.backgroundImage='url(/SportsScore/resources/images/button_a.gif)';
	}else{
		obj.style.backgroundImage='url(/SportsScore/resources/images/button_v.gif)';
  	}
}
