...
<s:if test="actionErrors.size()>0 || actionMessages.size()>0 || fieldErrors.size()>0">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="maginB">
	  <tr>
	    <td class="chaxunleft"><table width="100%" border="0" cellpadding="0" cellspacing="5">
	      <tr>
	        <td>&nbsp;</td>
			...
			<td align="center" nowrap="nowrap" class="">&nbsp;所在组：
				<s:select id="qgroup" name="qgroup" value="#parameters.qgroup[0]" list="allGroups" headerKey="" headerValue="----所有----" listKey="groupid" listValue="groupName" onchange="super_doSearch()"/>
			</td>
			<td>
		        <ul class="btn_gn">
			    <li><a href="#" title="查询" onclick="super_doSearch()"><span> 查询 </span></a></li>
			  </ul>
	            </td>
	      </tr>
	    </table></td>
    ...
    <table id="searchForm" border="0" align="center" cellspacing="3" cellpadding="0" width="100%" class="maginB">
    	...
    	<table id="buttonTable" border="0" cellspacing="3" cellpadding="0" width="100%">
    		<tr>
    			...
    			<ul class="btn_gn">
			    <li><a href="#" title="新增用户" onClick="input()"><span>新增用户</span></a></li>
			    <li><a href="#" title="修改用户" onclick="modifySelected()"><span>修改用户</span></a></li>
			    <li><a href="#" title="删除用户" onclick="submitRemove()"><span>删除用户</span></a></li>
			</ul>
    			</td>
    		</tr>
    	</table>
	  ...
	  <tr>
    	...
    	<s:iterator value="resultData">
    		<tr>
    			...
    			<td>
    				<a href="javascript:input('<s:property value="userid"/>',false)"><font color="blue"><s:property value="userLoginId"/></font></a>
    			</td>
    			<td>
    			...
    			<td>
    			[<a href="javascript:input('<s:property value="userid"/>',false)" ><FONT color="blue">编辑</FONT></a>]
    			</td>
    		</tr>
    	</s:iterator>
    		</tbody>
