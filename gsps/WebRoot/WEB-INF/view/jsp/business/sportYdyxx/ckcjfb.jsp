	  	...
	  	<tr>
				...
				<span style="font-size: 9pt">得分</span></td>
			 	...
			 	<s:iterator value="result1" status="st">
				  	<tr>
			    	      	<td width="180" align="center" height="21" bgcolor="#EEEEEE">
			                <span style="font-size: 9pt"><s:property value="bsxm"/></span></td>
			                <td width="70" align="center" height="21" bgcolor="#EEEEEE">
			                ...
			                <span style="font-size: 9pt" id="jp_<s:property value='#st.index' />"></span><script>changeValue(<s:property value='jps'/>,0,<s:property value='#st.index' />,'jp_')</script></td>
			                <td width="55" align="center" height="21" bgcolor="#EEEEEE">
			                <span style="font-size: 9pt" id="yp_<s:property value='#st.index' />"><script>changeValue(<s:property value='yps'/>,0,<s:property value='#st.index' />,'yp_')</script></span></td>
			                <td width="55" align="center" height="21" bgcolor="#EEEEEE">
			                <span style="font-size: 9pt" id="tp_<s:property value='#st.index' />"><script>changeValue(<s:property value='tps'/>,0,<s:property value='#st.index' />,'tp_')</script></span></td>
			                <td width="55" align="center" height="21" bgcolor="#EEEEEE">
 ...
 <table id="button">
 		<tr>
 			...
 			<td>
 				<ul class="btn_gn">
	 				<s:if test="%{#isprint==1}">
	 					<li><a href="#" title="打印" onclick="window.print();"><span>打印</span></a></li>
	 				</s:if>
